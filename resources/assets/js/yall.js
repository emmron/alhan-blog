...
var yall = function(userOptions) {
  ...
  const env = {
    ...
    ignoredImgAttributes: ["data-src", "data-sizes", "data-media", "data-srcset", "src", "srcset", "style"],
    acceptedDataAttributes: ["data-src", "data-sizes", "data-media", "data-srcset", "data-style"],
    eventsToBind: [
      [document, "scroll"],
      [document, "touchmove"],
      [window, "resize"],
